...
import com.mirea.productapp.dialog.ConfirmationDialog;
import com.mirea.productapp.dialog.TextInputDialog;
import com.mirea.productapp.shoppinglist.ListItem;
import com.mirea.productapp.shoppinglist.ListsChangeListener;
import com.mirea.productapp.shoppinglist.ShoppingList;
import com.mirea.productapp.shoppinglist.ShoppingListException;
import com.mirea.productapp.shoppinglist.ShoppingListMarshaller;
...
public class MainActivity extends BinderActivity implements
    ...
    @Override
    public void onPostCreate(@NotNull Bundle savedInstanceState, @NotNull PersistableBundle persistentState) {
